...
The `coder` specialist has `run_command`. Anyone who can reach this endpoint **with the API key** can run shell commands as your user on the Mac mini. Treat the key like an SSH private key.
